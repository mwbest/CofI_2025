...
#         """)
        ...
        self.detailed_steps_title = widgets.HTML("""
            ...
            <h2>Widget Tabs & Reduction Steps Explanations</h2>
            <p>This section details the operations within each tab It explains the GUI elements and the actions they perform.</p>
        
            <h2>Important Note on Defaults:</h2>
            <p>All parameters initially set to their default values. These defaults are generally sensible starting points based on experience. Modifying these parameters requires understanding their specific role and potential impact on the data reduction outcomes. It's advisable to consult the <code>astro-pyvista</code> library documentation, the KOSMOS MULTI-SLIT REDUCTION TUTORIAL.</p>
        """)
    ...
    def _get_tab1_calibration_html(self):
        ...
        <div class='help-section-text'>
            <h4>Purpose:</h4>
            <p>This tab is dedicated to creating the master calibration frames: Master Bias, Master Dark, Master Flat, and Master Arc(s). These are essential for correcting instrumental and terrestial effects in your science data.</p>
    ...
    def _get_master_dark_html(self):
        ...
        <div class='help-section-text'>
            ...
            <p><b>GUI Interaction:</b> Enter dark frame numbers (e.g., <code>94,95,96</code>) in "Dark Frames:" and click "Compute Dark". As a default bias is been applied to the darks to reduce the noise.</p>
